...
var vents = {
    ...
    calculate_invoice: function () {
        ...
        $.each(this.items.products, function (pos, dict) {
            dict.subtotal = dict.cant * parseFloat(dict.precioventa_productos);//cantidad por precio venta
...
// busqueda de productos
    ...
    $('form').on('submit', function (e) {
        ...
        vents.items.cli = $('select[name="cli"]').val();//id del cliente
